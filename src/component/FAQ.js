    ...
    >
      ...
      >
        ...
        <AccordionDetails>
          ...
          <Typography sx={{ m: 1 }}>
            First, our programs are designed so that people with basic computer
            ...
            regularly asking someone for help.
          </Typography>
          <Typography sx={{ m: 1 }}>
      ...
      >
        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
          <Typography>How much money will I make after graduation?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography sx={{ m: 1 }}>
      ...
      >
        ...
        <AccordionDetails>
          <Typography sx={{ m: 1 }}>
            Details will vary by course, but in general we have a mix of online
            and in-person options that blend live lectures, exercises, video
            content, group work, and projects.
          </Typography>
          <Typography sx={{ m: 1 }}>
            In most courses we try to prepare you for real working environments
