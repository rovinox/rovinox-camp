...
export default function Day14({ day, batchId, isAdmin }) {
      ...
      >
        {selectedDay.map((course, index) => (
         ...
         <Typography sx={{ mb: 5 }} component="p">
            Object Properties & Methods Part 2: changing and deleting
        </Typography>
        <ul style={{ width: "100%" }}>
          <li>You can delete any item in an object</li>
          <li>Deleting items does not have an effect on the</li>
